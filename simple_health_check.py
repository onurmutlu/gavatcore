...
class SimpleHealthCheck:
    ...
    def check_session_files(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = "healthy" if len(valid_sessions) >= 2 else "warning" if len(valid_sessions) >= 1 else "critical"
    ...
    def check_bot_configurations(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = "healthy" if len(available_bots) >= 2 else "warning" if len(available_bots) >= 1 else "critical"
