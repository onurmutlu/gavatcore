...
class HealthCheckSystem:
    ...
    def check_session_files(self) -> Dict[str, Any]:
        ...
        try:
            ...
            status = "healthy" if valid_sessions >= 2 else "warning" if valid_sessions >= 1 else "critical"
    ...
    def check_bot_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            available_bots = sum(1 for bot in persona_status.values() if bot["status"] == "available")
    ...
    for system, details in report['systems'].items():
        if isinstance(details, dict) and "status" in details:
            ...
            if system == "session_files":
                print(f"   📁 Sessions: {details.get('valid_sessions', 0)}/{details.get('session_count', 0)}")
                ...
                print(f"   🤖 Available Bots: {details.get('available_bots', 0)}/{details.get('expected_bots', 0)}")
