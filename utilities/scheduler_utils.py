...
async def spam_loop(client):
    ...
    from utilities.dynamic_spam_scheduler import start_dynamic_spam_system
    ...
    if profile.get("group_spam_enabled"):
        from utilities.adaptive_spam_scheduler import start_adaptive_spam
        await start_adaptive_spam(client, username, profile)
    
    # @arayisvips grup davet kampanyası başlat
    from utilities.group_invite_strategy import start_group_invite_campaign
