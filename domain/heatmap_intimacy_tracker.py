...
class HeatmapIntimacyTracker:
    ...
    def _load_intimacy_keywords(self) -> Dict[str, Dict[str, List[str]]]:
        ...
        return {
            IntimacyType.EMOTIONAL.value: {
                ...
                "low_intensity": [r"iyisin", r"hoş", r"güzel", r"memnun", r"rahat"],
            },
            IntimacyType.PHYSICAL.value: {
                ...
                "low_intensity": [r"merhaba", r"selam", r"görüşmek", r"buluşmak"],
            },
            IntimacyType.SEXUAL.value: {
                ...
                "low_intensity": [r"güzel", r"hoş", r"çekici", r"ilginç"],
            },
            IntimacyType.ROMANTIC.value: {
                ...
                "low_intensity": [r"nazik", r"kibarlık", r"centilmen", r"hanımefendi"],
            },
            IntimacyType.MENTAL.value: {
                ...
                "low_intensity": [r"fikrin", r"düşüncen", r"görüşün", r"yorumun"],
            },
            IntimacyType.SPIRITUAL.value: {
                ...
                "low_intensity": [r"inanç", r"din", r"maneviyat", r"felsefe"],
            },
        }
        ...
        cell.user_count = max(
            ...
            len(
                set(
                    ...
                    if m.timestamp.hour == hour and m.timestamp.weekday() == day_of_week
                )
            ),
        )
    ...
    def get_heatmap_visualization_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "total_interactions": sum(
                cell.interaction_count for row in self.intimacy_heatmap for cell in row
            ),
    ...
    async def generate_intimacy_report(
        self, user_id: str, character_id: str, days_back: int = 7
    ) -> IntimacyReport:
        """
        ...
        dominant_type = (
            max(type_scores.keys(), key=lambda t: type_scores[t])
            if type_scores
            else IntimacyType.EMOTIONAL
        )
